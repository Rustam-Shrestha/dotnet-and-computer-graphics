...
public class XShearTransformation extends Frame {
    private int[][] points;
    private int[][] shearedPoints;
    private double shx;
    private int midX, midY;

    public XShearTransformation() {
        ...
        this.setTitle("Shear Transformation in X-direction with Midpoint Translation");
